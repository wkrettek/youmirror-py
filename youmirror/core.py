...
class YouMirror:
    ...
    def __init__(
        ...
        self.path: Path = Path(root)                                # Wrap root in a path object for convenience
    ...
    def get_keys(self, yt: Union[Channel, Playlist, YouTube], keys: dict, options: dict, paths: dict) -> dict:
        '''
